...
export default function ShareSection() {
  ...
  const shareUrl = "https://intily.com/pnten";
  const shareText =
    "Spread the word about PinTude! \nShare it with your friends and family and help them discover its amazing benefits. \n";
  ...
  return (
    <>
      <div className="md:h-[32.875rem] w-full bg-[#DCE35B] h-[12.4375rem] md:px-[13.3125rem] px-[2.46875rem] flex items-center justify-center">
        <div className="w-full  md:h-[24.0625rem] h-[9.5rem] md:gap-2">
          <div className="w-full md:h-[10.3125rem] h-[3.25rem]  text-center  ">
            <h1 className="text-black font-bold text-[0.875rem] md:text-[2.75rem]">
              Your Network Deserves PinTude, <br />
              <span className="block">Share Now!</span>
            </h1>
          </div>
          <div className="md:w-[44.5625rem] md:h-[5.8125rem] w-[16.6875rem] h-[2.25rem]  text-center justify-self-center font-normal md:text-[2rem]  text-[0.75rem]">
            <p>
              Let your friends and family know about PinTude
              <br />
              <span className="block">
                and help them grow their business too!
              </span>
            </p>
          </div>
